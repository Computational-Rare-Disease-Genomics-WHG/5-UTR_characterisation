---
title: "2. 5'UTR Composition Analysis"
...
mane2 <-
  data.frame(
    "gene_id" = manesplit$Ensembl_Gene,
    "transcript_id" = manesplit$Ensembl_nuc,
    "HGNC" = manesplit$HGNC_ID_2,
    "gene" = manesplit$symbol
  )
...
TE_norderer <-
  read.delim("norderer TE 6.4.22.txt",
             sep = '\t',
             header = TRUE)
